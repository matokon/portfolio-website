  ...
  return (
    <section className={styles.container} id="eduexp">
      ...
      <h3 className={styles.text}>
        ...
        bez klasycznych wykładowców,<br></br> opierając się na samodzielnej pracy, współpracy i wzajemnym wsparciu w zespole. 
      ...
      <h3 className={styles.text}>
        ...
        Uczę głównie Pythona oraz Scratcha, a także wprowadzam w podstawy algorytmiki i logiki programistycznej.<br></br> 
